...
const gameState = {
  sceneWidth: sizes.width,
  sceneHeight: sizes.height,
  score: 0,
  music: true,
  sound: true,
};
...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.progressBox.strokeRect(630, 40, this.health + 4, 10);

    this.progressBar.fillStyle(0xffd700, 1);
    this.progressBar.fillRect(632, 40, this.health, 9);

    this.addGameBackground();

    this.player = this.physics.add
      .sprite(200, gameState.sceneHeight - 300, "player")
      .setScale(0.2);
