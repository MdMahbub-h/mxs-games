...
class OptionsScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.launchArrow = this.sound.add("launch-bubble");
    this.targetArrow = this.sound.add("target-bubble");
    this.nonTargetArrow = this.sound.add("non-target-bubble");
    ...
    if (!this.soundsOn) {
      ...
      this.launchArrow.setVolume(0);
      this.targetArrow.setVolume(0);
      this.nonTargetArrow.setVolume(0);
    ...
    this.soundBtn.on("pointerup", () => {
      if (this.soundsOn) {
        ...
        this.launchArrow.setVolume(1);
        this.targetArrow.setVolume(1);
        this.nonTargetArrow.setVolume(1);
