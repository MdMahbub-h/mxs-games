...
class OptionsScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.launchBullet = this.sound.add(SoundType.Shoot);
    this.enemyExplotion = this.sound.add(SoundType.InvaderKilled);
    this.playerExplotion = this.sound.add(SoundType.Kaboom);
    ...
    if (!this.soundsOn) {
      ...
      this.launchBullet.setVolume(0);
      this.enemyExplotion.setVolume(0);
      this.playerExplotion.setVolume(0);
    ...
    this.soundBtn.on("pointerup", () => {
      if (this.soundsOn) {
        ...
        this.launchBullet.setVolume(1);
        this.enemyExplotion.setVolume(1);
        this.playerExplotion.setVolume(1);
