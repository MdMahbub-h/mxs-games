...
class WelcomeScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio("egg-catch", ["assets/sounds/mp3/target-bubble.mp3", "assets/sounds/ogg/target-bubble.ogg"]);
    this.load.audio("egg-break", ["assets/sounds/mp3/non-target-bubble.mp3", "assets/sounds/ogg/non-target-bubble.ogg"]);
    ...
    this.load.image("bg", "assets/eggcatcher/BG2.png");
    this.load.image("owl", "assets/eggcatcher/owl2.png");
    this.load.image("egg", "assets/eggcatcher/fe3.png");
    this.load.image("basket", "assets/eggcatcher/basket2.png");
    this.load.image("money", "assets/eggcatcher/pngegg.png");
    this.load.image("brokenEgg", "assets/eggcatcher/brokenEgg.png");
  }
  ...
  create() {
    ...
    this.add
      .text(this.scale.width / 2, this.scale.height / 2 + 40, "Welcome to MXS Egg Catcher.\nPlay and get reward.", {
        fontSize: 26,
        align: "center",
        lineSpacing: 8,
      })
