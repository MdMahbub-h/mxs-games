...
class OptionsScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.eggCatch = this.sound.add("egg-catch");
    this.eggBreak = this.sound.add("egg-break");
    ...
    if (!this.soundsOn) {
      ...
      this.eggCatch.setVolume(0);
      this.eggBreak.setVolume(0);
    ...
    this.soundBtn.on("pointerup", () => {
      if (this.soundsOn) {
        ...
        this.eggCatch.setVolume(1);
        this.eggBreak.setVolume(1);
