  ...
  useLayoutEffect(() => {
    const resize = (ev) => {
      if (game.current) {
        ...
        if (canvas) {
          let padding = window.innerWidth > 580 && window.innerHeight > 760 ? 40 : 10;
          ...
          if (winRatio < gameRatio) {
            let canvasWidth = winWidth > 760 ? 760 : winWidth;
            let canvasHeight = winWidth / gameRatio > 580 ? 580 : winWidth / gameRatio;

            canvas.style.width = canvasWidth + "px";
            canvas.style.height = canvasHeight + "px";
          } else {
            let canvasWidth = winHeight * gameRatio > 760 ? 760 : winHeight * gameRatio;
